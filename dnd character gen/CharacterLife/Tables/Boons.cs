    ...
    public class Boons {
        ...
        public string Roll() {
            ...
            switch (randomNumber) {
                ...
                case 2: return "You saved the life of a commoner, who now owes you a life debt. This individual accompanies you on your travels and performs mundane tasks for you, but will leave if neglected, abused, or imperiled. Determine details about this character by using the supplemental tables and working with your DM."; //TODO: generate an individual??
                ...
                case 6: return "You found something interesting. You gain one additional trinket.";
