    ...
    internal class Tragedies
    {
        ...
        public string Roll()
        {
            ...
            { //TODO complete tragedy table rolls
                case 1:
                case 2: return "A family member or a close friend died. Roll on the Cause of Death supplemental table to find out how."; //this
                ...
                case 7: return "A lover disappeared without a trace. You have been looking for that person ever since."; //this
                ...
                case 12: return "A current or prospective romantic partner of yours died. Roll on the Cause of Death supplemental table to find out how. If the result is murder, roll a d12. On a 1, you were responsible, whether directly or indirectly."; //this
